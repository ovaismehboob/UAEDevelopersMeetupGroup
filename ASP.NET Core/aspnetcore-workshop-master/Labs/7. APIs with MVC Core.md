...
2. In the `Dependencies` section, add the `Microsoft.AspNetCore.Mvc.Core` package through NuGet, if missing:
...
1. In the `Dependencies` section, add the `Microsoft.AspNetCore.Mvc.Formatters.Json` package through NuGet:
...
1. In the `Dependencies` section, add the `Microsoft.AspNetCore.Mvc.DataAnnotations` package through NuGet, if missing
...
1. In the `Dependencies` section, add the `Microsoft.AspNetCore.Mvc.Formatters.Xml` package through NuGet, if missing
